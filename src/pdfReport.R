...
longRNASummaryFile <- countsFiles[grepl("longRNAs.*[:.:]summary", countsFiles)]
...
miRNASummaryFile <- countsFiles[grepl("miRNAs.*[:.:]summary", countsFiles)]
...
#handle biotypes
countLongFile <- countsFiles[grepl("longRNAs.*[:.:]gene_counts$", countsFiles)]
...
countMicroFile <- countsFiles[grepl("miRNAs.*[:.:]gene_counts$", countsFiles)]
